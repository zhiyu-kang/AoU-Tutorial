...
if (file.exists(glm.file)) {
  ...
  lp_beta_all_GLM<-drop(label_split_black$test$Z %*% beta_glm_all)
  concord_beta_all_GLM<-Q(lp_beta_all_GLM, C=label_split_black$test$labeled_data$C,delta = label_split_black$test$labeled_data$delta )
...
if (file.exists(delta.file)) {
  ...
  lp_beta_all_delta<-drop(label_split_black$test$Z %*% betadelta_all)
  concord_beta_all_delta<-Q(lp_beta_all_delta, C=label_split_black$test$labeled_data$C,delta = label_split_black$test$labeled_data$delta )
...
T_ssl_post <- tictoc({
  ...
  lp_beta_all_SSL <- drop(label_split_black$test$Z %*% betaSSL_all)
