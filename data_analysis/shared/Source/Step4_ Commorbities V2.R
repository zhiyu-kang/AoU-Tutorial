...
if (file.exists(glm.file)) {
  ...
  save(Z_blackscore_glm_te,Z_blackscore_glm_tr,beta_glm_blackscore,auc_black_glmscore,concord_beta_black_glm_score, file = glm.file)
...
if (file.exists(delta.file)) {
  ...
  save(Z_blackscore_delta_tr,Z_blackscore_delta_te,h_black, KC_black,auc_black_betadelta_score,concord_beta_black_delta_score, betadelta_black_score, file = delta.file)
}
...
save(betaSSL_black_score, auc_black_ssl_score, concord_beta_black_SSL_score,
     betak_black, Skb_black, Sk_black, h1_black, W.hat_black,Z_unlabelscore_mat_black,Z_blackscore_ssl_te,
     Z_blackscore_ssl_tr,file = ssl.file)
