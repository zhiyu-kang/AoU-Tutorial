"""Code Snippet 3 (Workbench V1): cohort demographics for the RA concept list."""
...
os.system(f"gsutil cp {bucket}/PheCode_714_1_Athena.csv .")
...
person_df = pandas.read_gbq(sql, dialect="standard")
