...
- For more details:
  - [Data Browser](https://databrowser.researchallofus.org/?_gl=1*1dhiymg*_ga*MzkzODA4NDQ3LjE3NDUyNzM5NTI.*_ga_K8QTQT89XP*czE3NjYxODY2OTkkbzExMiRnMSR0MTc2NjE4NzIzMyRqNjAkbDAkaDA.): preview aggregate counts and distributions across domains
  - [Survey Explorer](https://www.researchallofus.org/data-tools/survey-explorer/?_gl=1*11xq9r8*_ga*MzkzODA4NDQ3LjE3NDUyNzM5NTI.*_ga_K8QTQT89XP*czE3NjYxODY2OTkkbzExMiRnMSR0MTc2NjE4Njk0MSRqNDIkbDAkaDA.): browsing tool for the All of Us survey data
...
- Run the mapping R script: [Mapping ICD to SNOMED](extra/ICD_to_SNOMED.R)
...
- [`02_targeted_genomic_extraction.py`](illustration_snippets/workbench_v1/02_targeted_genomic_extraction.py)
  - Hail-based targeted extraction of selected RA SNPs from the ACAF-threshold
    MatrixTable.
- [`03_cohort_demographics.py`](illustration_snippets/workbench_v1/03_cohort_demographics.py)
  - Cohort demographics query driven by the RA concept list.
- [`04_condition_records.py`](illustration_snippets/workbench_v1/04_condition_records.py)
